...
<form method="POST" action="/EditUser/{{ $users->id }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" class="form-control" required  value="{{ $users->password }}" >
            </div>
